...
class Comment {
     ...
     * Add liked
     *
     * @param \Blogger\BlogBundle\Entity\User $liked
     *
     * @return Comment
     */
    public function addLiked(\Blogger\BlogBundle\Entity\User $liked)
    {
        $this->liked[] = $liked;
     ...
     * @param \Blogger\BlogBundle\Entity\User $liked
     */
    public function removeLiked(\Blogger\BlogBundle\Entity\User $liked)
    {
